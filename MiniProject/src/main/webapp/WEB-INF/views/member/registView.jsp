					...
					<div class="row gx-5 justify-content-center">
						<div class="col-lg-8 col-xl-6">
							...
							<form id="contactForm"
								...
								<div class="form-floating mb-3">
									<div class="d-flex justify-content-center">
										<img class="prof-img" id="imgBox"
											src="${pageContext.request.contextPath }/assets/default-prof.jpg">
								...
								<!-- id input-->
								<div class="form-floating mb-3">
									<input name="id" class="form-control" id="registId" type="text"
										placeholder="아이디" data-sb-validations="required" /> <label
										for="registId">아이디</label>
									<div class="invalid-feedback"
										data-sb-feedback="registId:required">아이디를 입력해주세요.</div>
								</div>
								<!-- pw input-->
								<div class="form-floating mb-3">
									<input name="pw" class="form-control" id="registPw"
										type="password" placeholder="비밀번호(4자리 이상)"
										data-sb-validations="required" /> <label for="registPw">비밀번호(4자리
										이상)</label>
									<div class="invalid-feedback"
										data-sb-feedback="registPw:required">비밀번호를 입력해주세요.</div>
								</div>
								<!-- Email address input-->
								<div class="form-floating mb-3">
									<input name="email" class="form-control" id="registEmail"
										type="email" placeholder="name@example.com"
										data-sb-validations="required,email" /> <label for="email">이메일</label>
									<div class="invalid-feedback"
										data-sb-feedback="registEmail:required">이메일을 입력해주세요.</div>
									<div class="invalid-feedback"
										data-sb-feedback="registEmail:email">유효하지 않은 이메일입니다.</div>
								</div>
								<!-- Phone number input-->
								<div class="form-floating mb-3">
									<input name="phone" class="form-control" id="registPhone"
										type="tel" placeholder="(123) 456-7890"
										data-sb-validations="required" /> <label for="registPhone">휴대폰번호</label>
									<div class="invalid-feedback"
										data-sb-feedback="registPhone:required">휴대폰번호를 입력해주세요</div>
								</div>
								<!-- entp input-->
								<div class="form-floating mb-3">
									<input name="entp" class="form-control" id="registEntp"
										type="text" placeholder="회사명" data-sb-validations="required" />
									<label for="registEntp">회사명</label>
									<div class="invalid-feedback"
										data-sb-feedback="registEntp:required">회사명을 입력해주세요.</div>
								</div>
